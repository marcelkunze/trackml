...
Processing is generally done in a container environment using a 50 event data set (training_000021450_000021499). The model can be tested by running it in a docker container:
