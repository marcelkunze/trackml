...
void mlp2(int nfiles=NFILES) {
    ...
    // Select first hit is on radial detector (r1!=0)
    ...
    factory->BookMethod(loader, TMVA::Types::kMLP, "MLP2", "!H:!V:NeuronType=tanh:VarTransform=N:NCycles=100:HiddenLayers=15,5:TestRate=5:!UseRegulator" );
